...
import vn.techres.supplier.model.request.CreatePaymentRequestRequest
...
open class CreatePaymentRequestParams : BaseRequest() {
    ///GETTER
    ///SETTER
    @JsonField(name = ["params"])
    var params = CreatePaymentRequestRequest()
}
