...
import vn.techres.supplier.adapter.specificationadapter.SpecificationPauseAdapter
...
class SpecificationPauseFragment : BaseBindingFragment<FragmentSpecificationActiceAndPauseBinding>(
        FragmentSpecificationActiceAndPauseBinding::inflate
), OnClickTransID,
        OnClickTransIdAndModelSpecification {

    private var adapter: SpecificationPauseAdapter? = null
    ...
    private fun fragmentCreate() {
        binding!!.txtTotalStatusSpecification.text = getString(R.string.txt_total_exchange_pause)
    }

    private fun setAdapter() {
        binding!!.recyclerView.layoutManager =
                LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        adapter = SpecificationPauseAdapter(mainActivity!!.baseContext)
    ...
    private fun searchSpecificationPause() {
        binding!!.txtSearchHome.setOnQueryTextListener(object :
