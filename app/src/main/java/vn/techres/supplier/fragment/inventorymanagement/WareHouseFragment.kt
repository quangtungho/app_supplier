...
import vn.techres.supplier.databinding.FragmentWareHouseBinding
...
class WareHouseFragment :
    BaseBindingFragment<FragmentWareHouseBinding>(FragmentWareHouseBinding::inflate),
    OnClickTransID {
    val tagName: String = WareHouseFragment::class.java.name
    ...
    private fun onBody() {
        ...
        binding!!.btnCreate.setOnClickListener {
            ...
            cacheManager.put(
                ...
                TechresEnum.TYPE_IN_WAREHOUSE.toString()
            )
    ...
    private fun fragmentCreate() {
        ...
        binding!!.txtTotalStatusWareHouse.text = getString(R.string.txt_status_tatol_warehouse)
    }

    private fun searchWareHouse() {
        binding!!.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                val newList = ArrayList<WareHouse>()
                for (key in listData) {
                    if (listData.size > 0) {
     ...
     */
    private fun getAPIListWareHouse(formDate: String, toDate: String) {
        val params = BaseParams()
        params.http_method = 0
        params.project_id = AppConfig.PROJECT_ID_SUPPLIER
        params.request_url =
            "/api/supplier-warehouse-sessions?type=${TechresEnum.STATUS_0},${TechresEnum.STATUS_2},${TechresEnum.STATUS_3}&from_date=$formDate&to_date=$toDate&limit=50&page=1"
