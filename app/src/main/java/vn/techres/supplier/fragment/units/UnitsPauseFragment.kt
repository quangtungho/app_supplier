...
import vn.techres.supplier.adapter.unitsadapter.UnitsPauseAdapter
...
class UnitsPauseFragment :
    ...
    private var adapter: UnitsPauseAdapter? = null
    private var adapterSpinner: SpinnerSpecificationInUnitsAdapter? = null
    val listData: ArrayList<DataUnits> = ArrayList()
    ...
    private fun fragmentCreate() {
        binding!!.txtTotalStatusSpecification.text = getString(R.string.txt_total_units_pause)
    }
    private fun setAdapter() {
        binding!!.recyclerView.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        adapter = UnitsPauseAdapter(mainActivity!!.baseContext)
        binding!!.recyclerView.adapter = adapter
        binding!!.recyclerView.setHasFixedSize(true)
