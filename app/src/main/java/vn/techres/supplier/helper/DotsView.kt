...
import vn.techres.supplier.helper.Utils.mapValueFromRangeToRange
import vn.techres.supplier.helper.Utils.clamp
import vn.techres.supplier.helper.DotsView
...
class DotsView : View {
    ...
    private fun updateDotsAlpha() {
        val progress = clamp(currentProgress.toDouble(), 0.6, 1.0)
            .toFloat()
