...
import vn.techres.supplier.view.CurrencyEditText.CurrencyTextWatcher
...
class CurrencyEditText @JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyleAttr: Int = R.attr.editTextStyle) : AppCompatEditText(context!!, attrs, defStyleAttr) {
