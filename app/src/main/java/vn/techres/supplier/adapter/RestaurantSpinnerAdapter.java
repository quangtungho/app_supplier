...
public class RestaurantSpinnerAdapter extends ArrayAdapter<Customer> {

    public RestaurantSpinnerAdapter(@NonNull Context context, int resource, @NonNull List<Customer> objects) {
    ...
    public View getView(int position, View convertView, @NotNull ViewGroup parent) {
        ...
        binding.txtResAddress.setVisibility(View.GONE);
        binding.txtResName.setGravity(Gravity.CENTER);
