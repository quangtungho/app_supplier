...
import vn.techres.supplier.databinding.ItemMediaImageBinding
import vn.techres.supplier.helper.AppUtils
import vn.techres.supplier.model.chat.data.ListFile

class MediaGroupAdapter(var context: Context) :
    RecyclerView.Adapter<MediaGroupAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val binding = ItemMediaImageBinding.bind(view)
    }
