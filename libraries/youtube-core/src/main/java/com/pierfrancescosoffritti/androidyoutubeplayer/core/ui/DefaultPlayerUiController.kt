...
internal class DefaultPlayerUiController(
    private val youTubePlayerView: LegacyYouTubePlayerView,
    private val youTubePlayer: YouTubePlayer
) : PlayerUiController, YouTubePlayerListener, YouTubePlayerFullScreenListener,
    ...
    private val volumeButton: ImageView
    ...
    init {
        ...
        val controlsView = View.inflate(
            ...
            R.layout.ayp_default_player_ui,
            youTubePlayerView
        )

        youTubePlayerMenu = DefaultYouTubePlayerMenu(youTubePlayerView.context)
        volumeButton = controlsView.findViewById(R.id.volume_button)
    ...
    override fun setVolume(
        icon: Drawable,
            ...
            volumeButton.setImageDrawable(icon)
        return this
    }
    override fun setVolumeListener(
        clickListener: View.OnClickListener?
    ): PlayerUiController {
    ...
    override fun showVolume(show: Boolean): PlayerUiController {
        volumeButton.visibility = if (show) View.VISIBLE else View.GONE
        return this
    }
