...
interface PlayerUiController {
    ...
    fun setVolume(icon: Drawable): PlayerUiController
    fun setVolumeListener(clickListener: View.OnClickListener?): PlayerUiController
    ...
    fun showVolume(show: Boolean): PlayerUiController
